...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Some classes (for example the standard library's socket class)
    # define their own send method which has nothing to do with Object#send.
    # So if you want to work with objects of any class,
