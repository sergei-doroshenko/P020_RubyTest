...
class AboutClassMethods < Neo::Koan
  ...
  #
  # self.method approach is good for adding one method
  # class << self approach is good for adding a batch of methods
  # it also provides better separation between class and instance methods
  # 
